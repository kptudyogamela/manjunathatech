...
export default function Contact() {
  return (
    <section id="contact-section" className="text-gray-600 body-font relative">
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-1/2 px-6">
              ...
              <p className="mt-1">
                No 32, Andrahalli Main Road, Near Shushruthi School,
                Hegganahalli, Bengaluru, Karnataka 560091
              </p>
            </div>
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a className="text-yellow-500 leading-relaxed">
                kantharajur2023@gmail.com
              </a>
              <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">
                PHONE
              </h2>
              <p className="leading-relaxed">+91 99007 26508</p>
            </div>
          </div>
        </div>
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <p className="leading-relaxed mb-5 text-gray-600">
            Send us your queries or feedback. We will get back to you promptly.
          </p>
          ...
          <p className="text-xs text-gray-500 mt-3">
            Your message will help us serve you better.
          </p>
        </div>
      </div>
    </section>
